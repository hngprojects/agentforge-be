...
def _build_verification_email(email: str, verification_url: str) -> tuple[str, str]:
    ...
    plain = (
        f"Hi,\n\n"
        f"Thanks for signing up! Please verify your email address by visiting "
        f"the link below:\n\n"
        f"{verification_url}\n\n"
    ...
    <tr>
      <td align="center">
        <table width="520" cellpadding="0" cellspacing="0"
          ...
          <!-- Accent bar -->
          <tr>
            <td style="background:#004744;height:3px;font-size:0;line-height:0;">
              &nbsp;
            </td>
          </tr>
...
def send_verification_email(email: str, token: str) -> None:
    ...
    try:
        ...
        logger.exception("Failed to send verification email via Brevo")
        raise
